...
var random_colors = ["FD841F","E0144C","54B435","4649FF","C47AFF","FF8787","790252"];
...
createStickyNote = (text) => {
    ...
    noteText.textContent = text;
      ...
      if(index > random_colors.length -1)
            ...
            note.setAttribute("style", `margin:${random_margin[(Math.random() * random_margin.length )]}; background-color:${random_color[(Math.random() * random_margin.length )]} `)
